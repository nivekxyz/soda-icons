...
install:
	mkdir -p $(DESTDIR)/usr/share/icons/Soda
	cp --no-preserve=mode,ownership -r \
		./Papirus/* \
		$(DESTDIR)/usr/share/icons/Soda
	cp --no-preserve=mode,ownership -r \
	    ./Soda\ Overrides/* \
	    $(DESTDIR)/usr/share/icons/Soda
	./icons-recolor.sh $(DESTDIR)/usr/share/icons/Soda/

post-install:
	-gtk-update-icon-cache -q $(DESTDIR)/usr/share/icons/Soda

uninstall:
	-rm -rf $(DESTDIR)/usr/share/icons/Soda
